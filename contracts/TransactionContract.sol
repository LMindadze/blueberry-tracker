...
contract TransactionContract {
    ...
    event ProductPurchased(uint256 transactionId, uint256 productId, address buyer);
    ...
    function buyProduct(uint256 _productId) public payable {
        ...
        transactions[transactionCount] = Transaction(transactionCount, _productId, msg.sender, block.timestamp);
        emit ProductPurchased(transactionCount, _productId, msg.sender);
